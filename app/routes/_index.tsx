    ...
    <main className="flex min-h-screen items-center justify-center px-4 py-16">
      <div className="flex min-h-0 flex-1 flex-col items-center gap-16">
        ...
        <div className="w-full max-w-[320px] space-y-6 px-4">
          <nav className="rounded-3xl border border-gray-200 p-6 space-y-4 dark:border-gray-700">
            <p className="text-center leading-6 text-gray-700 dark:text-gray-200">Pages</p>
            <ul>
